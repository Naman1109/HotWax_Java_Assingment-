...
<html>
    ...
    <body>
    <center><h1 class="hadding">Advance Java Assignment</h1></center>
    <div id="nav">

        <nav>
            <button id="buttonup" onclick="window.location.href = 'index.html';">Index</button> 
            <button id="buttonup" onclick="window.location.href = 'login.html';">Login</button> 
            <button id="buttonup" onclick="window.location.href = 'register.html';">Register</button> 
